...
# Note for Rust version

This repository is cut down from an original by [Emily Bache](https://github.com/emilybache/Tennis-Refactoring-Kata), and now only contains the Rust exercise that was called “TennisGame2”. The intent of this is to allow the team to do an exercise focused exclusively on the Extract Function refactoring.
